import os
from models import Inventory, Stock, Product, POS, POSSession, CashMovement, POSOrder, POSOrderLine, User
...
from routers.pos_workflow import router as pos_workflow_router
...
app.include_router(pos_workflow_router)
